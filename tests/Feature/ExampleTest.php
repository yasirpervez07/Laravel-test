...
class ExampleTest extends TestCase
{
    ...
    public function testMenu()
    {
        ...
        $response->assertStatus(200)
            ->assertJsonCount(1)
            ->assertJsonPath('0.name', 'All events')
            ->assertJsonPath('0.url', '/events')
            ->assertJsonPath('0.children.0.name', 'Laracon')
            ->assertJsonPath('0.children.0.url', '/events/laracon')
            ->assertJsonPath('0.children.0.children.0.name', 'Illuminate your knowledge of the laravel code base')
            ->assertJsonPath('0.children.0.children.0.url', '/events/laracon/workshops/illuminate')
            ->assertJsonPath('0.children.0.children.1.name', 'The new Eloquent - load more with less')
            ->assertJsonPath('0.children.0.children.1.url', '/events/laracon/workshops/eloquent')
            ->assertJsonPath('0.children.1.name', 'Reactcon')
            ->assertJsonPath('0.children.1.url', '/events/reactcon')
            ->assertJsonPath('0.children.1.children.0.name', '#NoClass pure functional programming')
            ->assertJsonPath('0.children.1.children.0.url', '/events/reactcon/workshops/noclass')
            ->assertJsonPath('0.children.1.children.1.name', 'Navigating the function jungle')
